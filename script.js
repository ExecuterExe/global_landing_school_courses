document.addEventListener('DOMContentLoaded', function () {
    ...
    const coursesData = {
        ...
        'ege-math': {
            ...
            brief: 'Интенсивный курс подготовки к ЕГЭ по профильной математике с ключевыми темами для уверенной сдачи',
            image: 'assets/ege-math.png',
            description: 'Добро пожаловать на наш интенсивный курс подготовки к ЕГЭ по математике профилю! За 25 насыщенных занятий мы проведем вас через все аспекты экзамена, от базовых понятий до сложных задач. Начнем с подробного разбора структуры ЕГЭ и критериев оценки, затем погрузимся в решение практических задач. Вы освоите все ключевые темы: числа и вычисления, уравнения и неравенства, функции и графики, геометрию и теорию вероятностей. Особое внимание уделим сложным заданиям второй части. Наш курс построен на последовательном изучении материала с постоянной практикой и закреплением знаний. Завершим подготовку интенсивным повторением и психологическим настроем на успех. Присоединяйтесь!',
            program: [
