document.addEventListener('DOMContentLoaded', function () {
    ...
    const coursesData = {
        ...
        'ege-math': {
            title: 'Математика (профиль) ЕГЭ',
            brief: 'Интенсивный курс подготовки к ЕГЭ по математике с ключевыми темами для уверенной сдачи',
            image: 'assets/ege-math.png',
            description: 'Добро пожаловать на наш интенсивный курс подготовки к ЕГЭ по математике! За 25 насыщенных занятий мы проведем вас через все аспекты экзамена, от базовых понятий до сложных задач. Начнем с подробного разбора структуры ЕГЭ и критериев оценки, затем погрузимся в решение практических задач. Вы освоите все ключевые темы: числа и вычисления, уравнения и неравенства, функции и графики, геометрию и теорию вероятностей. Особое внимание уделим сложным заданиям второй части, включая геометрические задачи. Наш курс построен на последовательном изучении материала с постоянной практикой и закреплением знаний. Завершим подготовку интенсивным повторением и психологическим настроем на успех. Присоединяйтесь!',
            program: [
                '1. Введение в экзамен: формат ЕГЭ, структура, критерии оценки, обзор демоверсии',
                '2. Простейшие уравнения (задание 6)',
                '3. Вычисления и преобразования (задание 7)',
                '4. Планиметрия (задание 1)',
                '5. Стереометрия (задание 3)',
                '6. Векторы (задание 2)',
                '7. Начала теории вероятностей и вероятности сложных событий (задания 4 и 5)',
                '8. Задачи с прикладным содержанием (задание 9)',
                '9. Текстовые задачи (задание 10)',
                '10. Текстовые задачи (продолжение)',
                '11. Производная и первообразная (задание 8)',
                '12. Графики функций (задание 11)',
                '13. Наибольшее и наименьшее значение функций (задание 12)',
                '14. Повторение заданий 1-12 (тестовая часть)',
                '15. Повторение заданий 1-12 (тестовая часть)',
                '16. Уравнения, пункт А (задание 13)',
                '17. Уравнения, пункт Б',
                '18. Неравенства (задание 15)',
                '19. Неравенства (продолжение)',
                '20. Финансовая математика: вклады (задание 16)',
                '21. Финансовая математика: кредиты',
                '22. Числа и их свойства, пункт А и Б (задание 19)',
                '23. Числа и их свойства, пункт В',
                '24. Повторение пройденного материала (задания 13-19)',
                '25. Итоговое повторение и психологическая настройка на экзамен'
            ],
            lifehacks: [
                'Доступ к базе актуальных экзаменационных заданий',
                'Интенсивная практика для закрепления навыков',
                'Домашние задания для эффективного усвоения материала',
                'Методики быстрого решения задач и распределения времени на экзамене',
                'Освоение новых способов решения сложных задач',
                'Навыки правильного оформления задач развернутой части',
                'Тренировка быстрого счета и вычислений',
                'Доступ к теоретическим материалам по всем типам заданий'
            ],
            duration: '25 занятий',
            price: '1000 руб. в мес.'
        },
        ...
        'ege-social': {
            ...
            brief: 'Интенсивный курс подготовки к ЕГЭ по обществознанию со вкусом!',
            image: 'assets/ege-social.png',
            description: 'Добро пожаловать на наш интенсивный курс подготовки к ЕГЭ по обществознанию! За 36 занятий, проходящих 2 раза в неделю, мы глубоко погрузимся во все ключевые разделы экзамена: человек и общество, экономика, социология, политика и право. Наша программа тщательно структурирована и охватывает весь необходимый материал для успешной сдачи ЕГЭ. Мы уделяем большое внимание как теоретической базе, так и практическому применению знаний. Наша цель - не только подготовить вас к успешной сдаче экзамена, но и сформировать целостное понимание общественных процессов, которое пригодится вам в дальнейшей учебе и жизни',
            program: [
                '1. Вводное занятие. Стратегия подготовки к экзамену. Обзор заданий и критериев оценивания.',
                'Раздел «Человек и общество»',
                '2. Человек и его потребности. Мировоззрение.',
                '3. Деятельность, свобода. Познание, мышление.',
                '4. Истина. Общество как система. Социальные институты.',
                '5. Типы обществ. Развитие общества.',
                '6. Культура. Мораль.',
                '7. Наука и научное познание. Образование.',
                '8. Религия. Искусство.',
                'Раздел «Экономика»',
                '9. Экономика как наука. Экономические системы и институты.',
                '10. Рациональное экономическое поведение. Спрос и предложение.',
                '11. Рынок и конкуренция. Рынок труда, безработица.',
                '12. Факторы производства, экономика фирмы. Предпринимательство.',
                '13. Банковская система. Финансовые институты, ценные бумаги.',
                '14. Инфляция. Роль государства в экономике.',
                '15. Государственный бюджет. Налоги.',
                '16. Экономическое развитие, экономические циклы. Мировая экономика.',
                'Раздел «Социология»',
                '17. Социальные группы и стратификация.',
                '18. Этнические общности и межнациональные отношения.',
                '19. Социальные роли, статусы и мобильность. Семья и брак.',
                '20. Социализация личности. Социальные нормы и контроль.',
                '21. Социальный конфликт. Государственная поддержка социально незащищённых слоёв.',
                'Раздел «Политика»',
                '22. Политическая власть. Политическая система. Государство, его функции.',
                '23. Политические режимы, форма государства. Гражданское общество.',
                '24. Федеративное устройство России. Органы государственной власти РФ.',
                '25. Политический процесс и политическое поведение. Коррупция.',
                '26. Политические партии. Избирательная система.',
                '27. Политическая элита и лидерство. Роль СМИ в политике.',
                'Раздел «Право»',
                '28. Право и правоотношения. Источники права, нормативно-правовые акты.',
                '29. Юридическая ответственность. Основы конституционного строя РФ.',
                '30. Права и свободы человека и гражданина в РФ.',
                '31. Гражданское право.',
                '32. Семейное право.',
                '33. Трудовое право. Права и обязанности налогоплательщика в РФ.',
                '34. Административное право. Экологическое право. Уголовное право.',
                '35. Гражданские споры и гражданский процесс. Правоохранительные органы РФ.',
                '36. Заключительное занятие. Обсуждение дальнейшей подготовки. Советы по сдаче экзамена.'
            ],
            lifehacks: [
                'Освоить все основные темы экзамена ЕГЭ',
                'Эффективно распределять время на экзамене',
                'Повысить свою уверенность при сдаче ЕГЭ'
            ],
            duration: '36 занятий (2 р. в неделю)',
            price: '1000 руб. в мес.'
        },
        'success-course': {
            title: 'Успешный специалист XXI века',
            brief: 'Поможет освоить ключевые навыки для любой успешной карьеры: от развития soft skills и планирования, до работы с ИИ и подготовки к трудоустройству',
            image: 'assets/success-course.png',
            description: "Наш курс — это увлекательный путь, помогающий старшеклассникам и студентам уверенно шагнуть в будущее. Вы узнаете, как выбрать профессию и развивать soft skills. Научитесь ставить цели и планировать карьеру, чтобы достигать успеха, не перегружаясь. " +
                "Но это еще не всё! Мы покажем вам, как эффективно обучаться, не тратя деньги, и как использовать инструменты искусственного интеллекта, такие как ChatGPT, для повышения продуктивности. Вы освоите навыки публичных выступлений, научитесь создавать презентации, которые запомнятся, и работать в команде, чтобы добиваться общих целей. " +
                "Обучение построено на минимуме теории и множестве практических кейсов для обдумывания и закрепления пройденного материала + домашка. " +
                "Присоединяйтесь, и этот курс станет вашим первым шагом к успешной профессиональной жизни в XXI веке!",
            program: [
                '1. Профориентация и самоопределение. Как понять что выбрать?',
                '2. Hard Skills и Soft Skills — баланс для успеха',
                '3. Целеполагание и планирование карьеры',
                '4. Как успевать всё и не сойти с ума',
                '5. Работа с информацией в XXI веке',
                '6. Как эффективно самообучаться, не потратив ни рубля на курсы?',
                '7. Работа с ИИ: применение ChatGPT в делах',
                '8. Публичные выступления в экономической деятельности',
                '9. Презентации, стоящие внимания людей. Как таких добиться?',
                '10. Коммуникации в команде. Как слаженно работать?',
                '11. Развитие проактивности и инициативности',
                '12. Организация рабочего пространства со вкусом',
                '13. Ноль опыта на рынке труда. Что делать?',
                '14. Резюме и всё, что с ним едят',
                '15. Красные флаги в вакансиях',
                '16. Страшное слово "собеседование" и как его пройти',
                '17. Удаленная работа — как сохранить продуктивность',
                '18. Как выжить в конкурентном океане',
                '19. Взаимодействие с токсичными людьми, где бы они не были',
                '20. Борьба со стрессом на рабочем месте',
                '21. Сбережения и инвестиции для молодого специалиста',
                '22. Хаос и неопределенность. Как в этом потоке не сойти с ума?'
            ],
            lifehacks: [
                'Определять свои сильные стороны',
                'Балансировать между hard и soft skills для достижения успеха',
                'Ставить цели и эффективно планировать карьеру',
                'Управлять временем и избегать выгорания',
                'Эффективно работать с информацией и находить нужные ресурсы',
                'Самостоятельно обучаться без финансовых затрат',
                'Использовать ИИ, включая ChatGPT, для повышения продуктивности',
                'Уверенно выступать публично и создавать впечатляющие презентации',
                'Распознавать "красные флаги" в вакансиях',
                'Сохранять продуктивность на удалённой работе',
                'Эффективно взаимодействовать с токсичными людьми',
                'Управлять стрессом на рабочем месте и в жизни',
            ],
            duration: '22 занятия',
            price: '1000 руб. в мес.'
        },
        'risk-management': {
            title: 'Риск-менеджмент в практике',
            brief: 'Обучение пониманию бизнеса и подготовкой к конкурсам. В РАЗРАБОТКЕ!',
            ...
            lifehacks: [
                'Получить знания в области финансов и бизнеса',
                'Получить опыт в создание проекта',
                'Развить личностные качества в ораторском искусстве',
                'Получить сертификат о прохождения курса "Риск-менеджмент в практике" от Алтайского филиала Финансового университета при Правительстве Российской Федерации'
            ],
            duration: '???',
            price: '1000 руб. в мес.'
        }
